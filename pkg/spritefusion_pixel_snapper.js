 ...
 * @param {number | null} [sensitivity]
 * @returns {Uint8Array}
 */
export function process_image(input_bytes, k_colors, sensitivity) {
    const ptr0 = passArray8ToWasm0(input_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.process_image(ptr0, len0, isLikeNone(k_colors) ? 0x100000001 : (k_colors) >>> 0, isLikeNone(sensitivity) ? 0x100000001 : (sensitivity) >>> 0);
    if (ret[3]) {
